...
const InputField: React.FC<Props>= ({todo, setTodo, handleAdd}) =>{
    ...
    return (
        ...
        onSubmit={(e)=>{handleAdd(e)}}>
            <input ref={inputRef} type = "input" placeholder='Enter your task' className=' bg-gray-300 p-3 w-full rounded-4xl focus:bg-gray-200 border-2 hover:border-purple-500' value={todo} onChange={(e)=>setTodo(e.target.value)}/>
